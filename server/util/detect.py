...
def set_interpreter(interpreter, image, resample=Image.NEAREST):
    ...
    set_input222(interpreter, image)
    interpreter.invoke()

def set_input222(interpreter, data):
...
# add scores and boxes to image
def print_objects_on_image(cv2_im, objs, labels, id_score_dict, detection_threshold):
